...
\- CREATE-FILE : CREATE-FILE ABORT ;
\- RESIZE-FILE : RESIZE-FILE ABORT ;
...
\    DUP   0xFF AND ?DUP        IF
	...
	EXKEY_F4 OF  VIEW-PAGE1 ENDOF
	EXKEY_F6 OF
   H_SCROLLING 0 VVVSETXY
   VIEW-#Y0 @ VIEW_BUF +
 VIEW-LINE-A2XY-.  ENDOF

	EXKEY_F7 OF  VIEW-PAGE ENDOF
		CASE
	 8 ALT+ OF\
	CTRL_Z_K OF;
			UNDO_A_BUF @ 
