...
REQUIRE [IF] /usr/forth/lib/CompIF4.4th 
...
REQUIRE >NUMBER /usr/forth/lib/number.4th
...
REQUIRE MODULE: /usr/forth/lib/spf_modules.4th
FLOAD /usr/forth/lib/fpcnum.4th
FLOAD /usr/forth/lib/dpoint.4th 
...
REQUIRE CASE /usr/forth/lib/case.4th

FLOAD /usr/forth/lib/exkey.4th


: KTST  BEGIN  KEY DUP H.  bl = UNTIL ;

\ KTST


FLOAD /usr/forth/tools/acc.4th  CO
FLOAD /usr/forth/tools/dir.4th
FLOAD /usr/forth/tools/NNC.4th
FLOAD /usr/forth/tools/edit.4th

: COLTST
 COLOR@
  $10 0 DO I COLOR! ." WWWW" I H. LOOP
 COLOR!
